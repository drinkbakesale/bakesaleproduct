  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 mt-5">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
              <Image
                src="/images/design-mode/icon-calories(1).png"
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
              <Image
                src="/images/design-mode/icon-smiley(1).png"
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
              <Image
                src="/images/design-mode/icon-leaf(1).png"
                alt="Leaf icon"
                width={32}
                height={32}
                className="w-8 h-8"
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
              <Image
                src="/images/design-mode/icon-lightning(1).png"
      ...
      <div className="mb-6 mt-9">
        <Image
          src="/images/design-mode/pouches-on-ice(1).webp"
      ...
      <div className="mb-6 mt-0">
        <Image
          src="/images/design-mode/gardening-gradient(1).webp"
        ...
        <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "375/667" }}>
          {!showVideo ? (
            <div className="relative w-full h-full">
              <Image
                src="/images/design-mode/new-video-thumbnail(1).webp"
      ...
      <div className="px-6 mb-6 mt-9">
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="text-center">
            <Image
              src="/images/design-mode/movie-nights(1).webp"
              alt="Movie nights"
              width={80}
              height={80}
          ...
          <div className="text-center">
            <Image
              src="/images/design-mode/chill(1).png"
          ...
          <div className="text-center">
            <Image
              src="/images/design-mode/winding-down(1).webp"
              alt="Winding down"
              width={80}
              height={80}
              className="w-full aspect-square object-cover rounded-lg mb-2"
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center">
            <Image
              src="/images/design-mode/book-club(1).webp"
              alt="Book club"
              width={80}
              height={80}
              className="w-full aspect-square object-cover rounded-lg mb-2"
          ...
          <div className="text-center">
            <Image
              src="/images/design-mode/bath(1).png"
      ...
      <div className="relative mt-24 mb-6 pt-9">
        <Image
          src="/images/design-mode/ways-to-wind-down(1).webp"
