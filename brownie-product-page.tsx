  ...
  return (
    ...
    >
      ...
      <div className="px-6 mb-4" id="pricing-section">
        <div className="grid grid-cols-2 gap-4 mb-6 mt-5">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
              <Image
                src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/icon-smiley.png"
      ...
      <div className="mb-6 mt-9">
        <Image
          src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/pouches-on-ice.webp"
                ...
                <div className="px-3 py-3 text-sm border-t" style={{ color: "#531700", borderColor: "#E4A830" }}>
                  {faq.answer === "image" ? (
                    <div className="flex justify-center">
                      <Image
                        src="/images/design-mode/nutritional(1).png"
                        alt="Nutrition Facts"
                        width={300}
                        height={400}
      ...
      <div className="mb-6 mt-0">
        <Image
          src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/gardening-gradient.webp"
        ...
        <div className="relative rounded-2xl overflow-hidden" style={{ aspectRatio: "375/667" }}>
          {!showVideo ? (
            <div className="relative w-full h-full">
              <Image
                src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/new-video-thumbnail.webp"
      ...
      <div className="px-6 mb-6 mt-9">
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="text-center">
            <Image
              src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/movie-nights.webp"
              alt="Movie nights"
              width={80}
              height={80}
          ...
          <div className="text-center">
            <Image
              src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/chill.png"
          ...
          <div className="text-center">
            <Image
              src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/winding-down.webp"
              alt="Winding down"
              width={80}
              height={80}
              className="w-full aspect-square object-cover rounded-lg mb-2"
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center">
            <Image
              src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/book-club.webp"
              alt="Book club"
              width={80}
              height={80}
              className="w-full aspect-square object-cover rounded-lg mb-2"
          ...
          <div className="text-center">
            <Image
              src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/bath.png"
          ...
          <div className="text-center">
            <Image
              src="/images/design-mode/resetting(1).png"
              alt="Resetting"
              width={80}
              height={80}
              className="w-full aspect-square object-cover rounded-lg mb-2"
      ...
      <div className="relative mt-24 mb-6 pt-9">
        <Image
          src="https://mghzzpn2s9ixrl0b.public.blob.vercel-storage.com/product/images/ways-to-wind-down.webp"
